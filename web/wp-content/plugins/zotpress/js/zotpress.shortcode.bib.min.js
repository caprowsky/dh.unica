...
{if(zp_items.data==0)
zp_items.data='No items found.';console.log('There was a Zotpress error: '+zp_items.data);var hideErrMsg='';if(jQuery("#"+zp_items.instance+" .zp-List .zp-Entry").length>0)
hideErrMsg=' class="hide"';jQuery("#"+zp_items.instance+" .zp-List").removeClass('loading').append('<p'+hideErrMsg+'>There was a Zotpress error: '+zp_items.data+'</p>')}
...
{var sortby=jQuery(".ZP_SORTBY",$instance).text();var orderby=jQuery(".ZP_ORDER",$instance).text();var sortOrder="data-zp-author-date";if(sortby=="date")sortOrder="data-zp-date-author";if(zp_params.zpTitle!==!1)
{var titleSortedEntries={};typicalSort(zp_items,sortby,sortOrder,orderby);jQuery("#"+zp_items.instance+" .zp-List div.zp-Entry").each(function(i,entry)
...
{if((zp_items.meta.request_last!=0&&zp_items.meta.request_next!=0)&&jQuery("#"+$instance.attr("id")+" .zp-List h3[rel='"+orderedType+"']").length==0)
{var $last=jQuery("#"+$instance.attr("id")+" .zp-List h3:eq(0)");jQuery("#"+$instance.attr("id")+" .zp-List h3").each(function(i,e)
{if(orderby=="asc"&&parseInt(jQuery(e).attr("rel"))>parseInt(tempTitle))
{$last.before("<h3 rel='"+orderedType+"'>"+tempTitle+"</h3>\n");return!1}
else if(orderby=="desc"&&parseInt(jQuery(e).attr("rel"))<parseInt(tempTitle))
...
{jQuery("#"+$instance.attr("id")+" .zp-List h3[rel='"+orderedType+"']").after(jQuery("#"+entryID))})})}
else{typicalSort(zp_items,sortby,sortOrder,orderby)}}
