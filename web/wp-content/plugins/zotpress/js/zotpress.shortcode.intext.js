jQuery(document).ready(function()
{
						...
						else // Otherwise, finish up and/or check for updates
						{
							...
							else // Or finish up
							{
								...
								else // Re-sort numbering
								{
									...
									console.log("numbering resort? if no csl-left-margin")
								}
							}
						}
					}
	...
	function zp_format_intextbib ( $instance, zp_items, zp_itemkeys, params, update )
	{
				...
				&& update === false )
		{
			...
			{
				// REVIEW: Not necessary?
				console.log("no entries, hasnum, not updating");
			...
			else // Subsequent requests for this bib
			{
				...
				{
					// Get item info
					// var item = tempItemsArr[tempItemsArr[num]];
		...
		{
			// REVIEW: Not necessary?
			console.log("not hasnum or updating");
