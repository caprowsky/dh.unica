...
function Zotpress_func( $atts )
{
    ...
    $instance_id = "zotpress-".md5($api_user_id.$nickname.$temp_author.$temp_year.$item_type.$temp_collection_id.$temp_item_key.$temp_tag_name.$style.$temp_sortby.$order.$limit.$showimage.$showtags.$downloadable.$shownotes.$citeable.$inclusive);
