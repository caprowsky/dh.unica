...
//  to publish result list 
    ...
    if (WPxdamsBridge_searchHasResults()) 
		...
		$nextResultPre		= WPxdamsBridge_getNextResultPreview('200' , 'class="img-responsive"') ;  // pic for preview
		$nextResult 		= WPxdamsBridge_getNextResult();        // text to show
                ...
                $thumbsItem     	= $thumbsItem.'
                                <li class="carousel-xd-preview">'.'<a id="carousel-selector-'.$prog.'"' . $thumbClass .'>'.$nextResultPre.'</a></li>';
