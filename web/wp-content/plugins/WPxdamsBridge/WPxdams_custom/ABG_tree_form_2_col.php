...
*/
		...
		$redirect               = WPxdamsBridge_getSearchRedirectionUrl();
                $currresults            = WPxdamsBridge_getTerms('text_found').'<br>'. WPxdamsBridge_getTotalResultItems().' '.WPxdamsBridge_getTerms('text_element', WPxdamsBridge_getTotalResultItems());// WPxdamsBridge_getTerms('text_results') ;
           //     if ($inputValue) {
        //            $per                = ' per 
      ...
      //          }
                ...
                if(WPxdamsBridge_getTotalResultItems() > 0 ) {
                    $printResults      =  '  
                                                ...
                                                '.WPxdamsBridge_getTotalResultPages() .' '.WPxdamsBridge_getTerms('text_pages', WPxdamsBridge_getTotalResultPages()  );
                } 
